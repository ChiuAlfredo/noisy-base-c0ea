...
```
npm create cloudflare@latest -- --template=cloudflare/templates/noisy-base-c0ea
```

A live public deployment of this template is available at [https://noisy-base-c0ea.templates.workers.dev](https://noisy-base-c0ea.templates.workers.dev)
